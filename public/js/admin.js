...
$(document).ready(function() {
	...
	widgetClose.find('a').click(function (event) {
		event.preventDefault();
		var $this = $(this);
	...
	widgetOpen.find('a').click(function (event) {
	event.preventDefault();
	var $this = $(this);
	if($this .hasClass('minimize')) {
		//minimize content
	...
	$("div.dialog button").addClass("button orange");
	...
	$('#calendar').fullCalendar({
		...
		buttonText: {
	        prev: '<span class="icon thinArrowLeft dark small"></span>',
	        next: '<span class="icon thinRightArrow dark small"></span>'
	    },
		editable: true,
		events: [
			{
	...
	$('.icons>li>span') .tipsy({title: 'class'});
