		            	...
		            	<form class="form wizzard" action="" id="signupForm">
		            		<ul>
				            		...
				            		<li>
					                    ...
					                    <div class="input threeFourth"><input type="text" id="name" name="name" value="<?php echo $user->username;?>"/></div>
					                    <div class="clear"></div>
					                </li>
                                     <li class="lastest">
                                     ...
                                     <li class="lastest">
					                    ...
					                    <div class="input threeFourth"><input type="text" id="name" name="name" value="<?php echo $user->password?>"/></div>
					                   <div class="clear"></div>
					                </li>
					                ...
					                <li class="lastest">
					                	<button class="button gray">确认提交</button>
					                </li>
				            	</fieldset>
				            </ul>	  
