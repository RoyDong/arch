...
<div id="container"><!-- Container -->
	...
	<div id="sidebar">
		...
		<div class="navigation">
			<ul class="mainnav">
				...
				<li class="iAvatar">
					<a href="#"><img src="images/avatar.png" alt="avatar" /><span class="txt">欢迎回来，管理员 XXX</span></a>
					<ul class="sub">
				...
				<li>
					...
					<ul class="sub expand">
						...
						<li><a href="adduser.html" class="current"><span class="icon userAdd small"></span>增加新用户</a></li>
					</ul>
				</li>
                                <li>
	...
	<div id="content">
		...
		<div class="topArea">
			...
			<!-- search -->
			<div class="tSearch">
				<a href="#" class="button gray onlyIcon16"><span class="icon search dark small">搜索</span></a>
				<form action="#">
					<input type="text" name="searchtxt" class="topSearch" placeholder="搜索 ..." />
